...
namespace SciFiGame.Player
{
    ...
    public class PlayerAnimationComponent : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            handsLayerIndex = _animator.GetLayerIndex("HandsLayer");
        }
        ...
        private void Update()
        {
            ...
            SetHandsLayerWeight(_movement.CrouchBlend);
        }

        public void SetHandsLayerWeight(float targetWeight)
        {
            // Clamp ensures the weight stays strictly between 0 (off) and 1 (fully overriding)
            targetWeight = Mathf.Clamp01(targetWeight);

           _animator.SetLayerWeight(handsLayerIndex, targetWeight);
        }
